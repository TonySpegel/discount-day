 ...
 */function dc(e,t,r){return e?t():r==null?void 0:r()}var hc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,Se=(e,t,r,i)=>{for(var o=i>1?void 0:i?uc(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=(i?s(t,r,o):s(o))||o);return i&&o&&hc(t,r,o),o};let Gt=class extends et{constructor(){super(...arguments);this.business="",this.category="",this.discountName="",this.price=4.9,this.formatPrice=e=>new Intl.NumberFormat("de-DE",{style:"currency",currency:"EUR"}).format(e)}static get styles(){return[Lt`
    ...
    `}constructor(){super()}firstUpdated(){var t;const e=new gt((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet"));console.log("/discount-day/"),e.setRoutes([{path:"/discount-day/",animate:!0,children:[{path:"",component:"app-discount"},{path:"discount",component:"app-discount",action:async()=>{await ur(()=>Promise.resolve().then(function(){return El}),void 0)}},{path:"about",component:"app-about",action:async()=>{await ur(()=>import("./app-about.b2dd316c.js"),[])}},{path:"stats",component:"app-stats",action:async()=>{await ur(()=>import("./app-stats.f1728656.js"),[])}}]}])}render(){return N`
      <div>
        <main>
...
//# sourceMappingURL=index.0195dd76.js.map
