 ...
 */function Il(e,t,r){return e?t():r==null?void 0:r()}var jl=Object.defineProperty,Hl=Object.getOwnPropertyDescriptor,fe=(e,t,r,i)=>{for(var n=i>1?void 0:i?Hl(t,r):t,o=e.length-1,s;o>=0;o--)(s=e[o])&&(n=(i?s(t,r,n):s(n))||n);return i&&n&&jl(t,r,n),n};let zt=class extends H{constructor(){super(...arguments);this.business="",this.category="",this.discountName="",this.price=4.9,this.formatPrice=e=>new Intl.NumberFormat("de-DE",{style:"currency",currency:"EUR"}).format(e)}static get styles(){return[At`
    ...
    `}constructor(){super()}firstUpdated(){var t;new ht((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/discount-day/",animate:!0,children:[{path:"",component:"app-discount"},{path:"discount",component:"app-discount",action:async()=>{await Xr(()=>Promise.resolve().then(function(){return nl}),void 0)}},{path:"about",component:"app-about",action:async()=>{await Xr(()=>import("./app-about.3db55080.js"),[])}}]}])}render(){return R`
      <div>
        <main>
...
//# sourceMappingURL=index.6a0e9b4f.js.map
