 ...
 */const Ki=typeof window!="undefined"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,Mr=(e,t,r=null)=>{for(;t!==r;){const i=t.nextSibling;e.removeChild(t),t=i}},lt=`{{lit-${String(Math.random()).slice(2)}}}`,Go=`<!--${lt}-->`,Yi=new RegExp(`${lt}|${Go}`);class Xo{constructor(t,r){this.parts=[],this.element=r;const i=[],o=[],n=document.createTreeWalker(r.content,133,null,!1);let s=0,l=-1,a=0;const{strings:c,values:{length:u}}=t;for(;a<u;){const d=n.nextNode();if(d!==null){if(l++,d.nodeType===1){if(d.hasAttributes()){const h=d.attributes,{length:p}=h;let g=0;for(let v=0;v<p;v++)Ji(h[v].name,"$lit$")&&g++;for(;g-- >0;){const v=c[a],y=Ur.exec(v)[2],b=y.toLowerCase()+"$lit$",w=d.getAttribute(b);d.removeAttribute(b);const _=w.split(Yi);this.parts.push({type:"attribute",index:l,name:y,strings:_}),a+=_.length-1}}d.tagName==="TEMPLATE"&&(o.push(d),n.currentNode=d.content)}else if(d.nodeType===3){const h=d.data;if(h.indexOf(lt)>=0){const p=d.parentNode,g=h.split(Yi),v=g.length-1;for(let y=0;y<v;y++){let b,w=g[y];if(w==="")b=ft();else{const _=Ur.exec(w);_!==null&&Ji(_[2],"$lit$")&&(w=w.slice(0,_.index)+_[1]+_[2].slice(0,-5)+_[3]),b=document.createTextNode(w)}p.insertBefore(b,d),this.parts.push({type:"node",index:++l})}g[v]===""?(p.insertBefore(ft(),d),i.push(d)):d.data=g[v],a+=v}}else if(d.nodeType===8)if(d.data===lt){const h=d.parentNode;d.previousSibling!==null&&l!==s||(l++,h.insertBefore(ft(),d)),s=l,this.parts.push({type:"node",index:l}),d.nextSibling===null?d.data="":(i.push(d),l--),a++}else{let h=-1;for(;(h=d.data.indexOf(lt,h+1))!==-1;)this.parts.push({type:"node",index:-1}),a++}}else n.currentNode=o.pop()}for(const d of i)d.parentNode.removeChild(d)}}const Ji=(e,t)=>{const r=e.length-t.length;return r>=0&&e.slice(r)===t},Zo=e=>e.index!==-1,ft=()=>document.createComment(""),Ur=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function Gi(e,t){const{element:{content:r},parts:i}=e,o=document.createTreeWalker(r,133,null,!1);let n=ce(i),s=i[n],l=-1,a=0;const c=[];let u=null;for(;o.nextNode();){l++;const d=o.currentNode;for(d.previousSibling===u&&(u=null),t.has(d)&&(c.push(d),u===null&&(u=d)),u!==null&&a++;s!==void 0&&s.index===l;)s.index=u!==null?-1:s.index-a,n=ce(i,n),s=i[n]}c.forEach(d=>d.parentNode.removeChild(d))}const Qs=e=>{let t=e.nodeType===11?0:1;const r=document.createTreeWalker(e,133,null,!1);for(;r.nextNode();)t++;return t},ce=(e,t=-1)=>{for(let r=t+1;r<e.length;r++){const i=e[r];if(Zo(i))return r}return-1};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const ea=` ${lt} `;class Qo{constructor(t,r,i,o){this.strings=t,this.values=r,this.type=i,this.processor=o}getHTML(){const t=this.strings.length-1;let r="",i=!1;for(let o=0;o<t;o++){const n=this.strings[o],s=n.lastIndexOf("<!--");i=(s>-1||i)&&n.indexOf("-->",s+1)===-1;const l=Ur.exec(n);r+=l===null?n+(i?ea:Go):n.substr(0,l.index)+l[1]+l[2]+"$lit$"+l[3]+lt}return r+=this.strings[t],r}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
@lit/reactive-element/decorators/query-assigned-nodes.js:
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/var Hr=class extends W{constructor(){super(...arguments);this.hasSlotController=new ai(this,"footer","header","image")}render(){return Z`
      <div
        part="base"
...
`,Vr=class extends W{constructor(){super(...arguments);this.localize=new ar(this)}render(){return Z`
      <svg part="base" class="spinner" role="progressbar" aria-valuetext=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};Vr.styles=Fa;Vr=f([nt("sl-spinner")],Vr);var Wr="";function go(e){Wr=e}function Va(){if(!Wr){const e=[...document.getElementsByTagName("script")],t=e.find(r=>r.hasAttribute("data-shoelace"));if(t)go(t.getAttribute("data-shoelace"));else{const r=e.find(o=>/shoelace(\.min)?\.js($|\?)/.test(o.src));let i="";r&&(i=r.getAttribute("src")),go(i.split("/").slice(0,-1).join("/"))}}return Wr.replace(/\/$/,"")}var Wa={name:"default",resolver:e=>`${Va()}/assets/icons/${e}.svg`},qa=Wa,vo={caret:`
  ...
  `},Ka={name:"system",resolver:e=>e in vo?`data:image/svg+xml,${encodeURIComponent(vo[e])}`:""},Ya=Ka,Ja=[qa,Ya],qr=[];function Ga(e){qr.push(e)}function Xa(e){qr=qr.filter(t=>t!==e)}function bo(e){return Ja.find(t=>t.name===e)}var Cr=new Map;function Za(e,t="cors"){if(Cr.has(e))return Cr.get(e);const r=fetch(e,{mode:t}).then(async i=>({ok:i.ok,status:i.status,html:await i.text()}));return Cr.set(e,r),r}var kr=new Map;async function Qa(e){if(kr.has(e))return kr.get(e);const t=await Za(e),r={ok:t.ok,status:t.status,svg:null};if(t.ok){const i=document.createElement("div");i.innerHTML=t.html;const o=i.firstElementChild;r.svg=(o==null?void 0:o.tagName.toLowerCase())==="svg"?o.outerHTML:""}return kr.set(e,r),r}var tl=tt`
  ${ot}
...
`,Kr=class extends bn{constructor(e){if(super(e),this.it=S,e.type!==gn.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===S||e==null)return this._t=void 0,this.it=e;if(e===yt)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};Kr.directiveName="unsafeHTML",Kr.resultType=1;var Yr=class extends Kr{};Yr.directiveName="unsafeSVG",Yr.resultType=2;var el=vn(Yr),Pr,it=class extends W{constructor(){super(...arguments);this.svg="",this.label="",this.library="default"}connectedCallback(){super.connectedCallback(),Ga(this)}firstUpdated(){this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Xa(this)}getUrl(){const e=bo(this.library);return this.name&&e?e.resolver(this.name):this.src}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const t=bo(this.library),r=this.getUrl();if(Pr||(Pr=new DOMParser),r)try{const i=await Qa(r);if(r!==this.getUrl())return;if(i.ok){const n=Pr.parseFromString(i.svg,"text/html").body.querySelector("svg");n!==null?((e=t==null?void 0:t.mutator)==null||e.call(t,n),this.svg=n.outerHTML,this.emit("sl-load")):(this.svg="",this.emit("sl-error"))}else this.svg="",this.emit("sl-error")}catch{this.emit("sl-error")}else this.svg.length>0&&(this.svg="")}render(){return Z` ${el(this.svg)} `}};it.styles=tl;f([sr()],it.prototype,"svg",2);f([m({reflect:!0})],it.prototype,"name",2);f([m()],it.prototype,"src",2);f([m()],it.prototype,"label",2);f([m({reflect:!0})],it.prototype,"library",2);f([dt("label")],it.prototype,"handleLabelChange",1);f([dt(["name","src","library"])],it.prototype,"setIcon",1);it=f([nt("sl-icon")],it);/*! Bundled license information:
...
`;var rl=Object.defineProperty,il=Object.getOwnPropertyDescriptor,Cn=(e,t,r,i)=>{for(var o=i>1?void 0:i?il(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=(i?s(t,r,o):s(o))||o);return i&&o&&rl(t,r,o),o};let Jr=class extends et{constructor(){super();this.message="Welcome!"}static get styles(){return[Sn,Lt`
      #welcomeBar {
        display: flex;
        justify-content: center;
        align-items: center;
 ...
 */const ol=Symbol();class nl{constructor(t,r,i){this.i=0,this.status=0,this.autoRun=!0,this.o=t,this.o.addController(this);const o=typeof r=="object"?r:{task:r,args:i};this.t=o.task,this.h=o.args,this.l=o.onComplete,this.u=o.onError,o.autoRun!==void 0&&(this.autoRun=o.autoRun),this.taskComplete=new Promise((n,s)=>{this.v=n,this._=s})}hostUpdated(){this.performTask()}async performTask(){var t;const r=(t=this.h)===null||t===void 0?void 0:t.call(this);this.shouldRun(r)&&this.run(r)}shouldRun(t){return this.autoRun&&this.m(t)}async run(t){var r,i,o;let n,s;t!=null||(t=(r=this.h)===null||r===void 0?void 0:r.call(this)),this.status!==2&&this.status!==3||(this.taskComplete=new Promise((a,c)=>{this.v=a,this._=c})),this.status=1,this.o.requestUpdate();const l=++this.i;try{n=await this.t(t)}catch(a){s=a}if(this.i===l){if(n===ol)this.status=0;else{if(s===void 0){try{(i=this.l)===null||i===void 0||i.call(this,n)}catch{}this.status=2,this.v(n)}else{try{(o=this.u)===null||o===void 0||o.call(this,s)}catch{}this.status=3,this._(s)}this.T=n,this.k=s}this.o.requestUpdate()}}get value(){return this.T}get error(){return this.k}render(t){var r,i,o,n;switch(this.status){case 0:return(r=t.initial)===null||r===void 0?void 0:r.call(t);case 1:return(i=t.pending)===null||i===void 0?void 0:i.call(t);case 2:return(o=t.complete)===null||o===void 0?void 0:o.call(t,this.value);case 3:return(n=t.error)===null||n===void 0?void 0:n.call(t,this.error);default:this.status}}m(t){const r=this.p;return this.p=t,Array.isArray(t)&&Array.isArray(r)?t.length===r.length&&t.some((i,o)=>ri(i,r[o])):t!==r}}function sl(e){return function(t){return class extends t{constructor(...r){super(...r);at.set(this,[]),Object.keys(this).forEach(o=>{const n=Object.getOwnPropertyDescriptor(this,o);n!=null&&n.writable&&_o(t,this,o,e,n.value)});const i=cl.get(t.prototype);if(i)for(const o of i)Object.getOwnPropertyDescriptor(this,o)||_o(t,this,o,e);!(e!=null&&e.noSeal)&&Object.seal(this)}}}}function yo(e,t,r){var i,o;if(e.value instanceof Object&&at.has(e.value)&&at.set(e.value,at.get(e.value).filter(({parent:n})=>n!=e)),t instanceof Object&&at.has(t)&&((i=at.get(t))===null||i===void 0||i.push({parent:e,propKey:r})),t instanceof Array)for(const n of t)n instanceof Object&&at.has(n)&&((o=at.get(n))===null||o===void 0||o.push({parent:e,propKey:r}))}function _o(e,t,r,i,o){const n=ll(dl(e,r,i)),s=new al(t,r,n,o);yo(s,o,r),Object.defineProperty(t,r,{enumerable:!0,set(l){if(s.options.lock&&s.options.lock.symbol!==pl)throw new ul(s.key);yo(s,l,r),s.options.set(s,l)},get(){return kt&&s.observers.add(kt),s==null?void 0:s.options.get(s)}})}class al{constructor(t,r,i,o){this.parent=t,this.key=r,this.options=i,this._value=o,this.observers=new Set,this.options.init&&(this._value=this.options.init(this,o),i.notifyOnInit&&this.notifyObservers())}get value(){return this._value}set value(t){this._value=t,this.notifyObservers()}notifyObservers(){for(const r of this.observers.keys())r.update();for(const r of this.options.observers)r(new Set([this]));const t=at.get(this.parent);for(const{parent:r}of t)r.notifyObservers()}}function ll({observers:e=[],notifyOnInit:t=!1,noSeal:r=!1,lock:i=null,init:o=function(a,c){return c},set:n=function(a,c){a.value!==c&&(a.value=c)},get:s=function(a){return a.value}}={}){return{lock:i,set:n,get:s,init:o,observers:e,notifyOnInit:t,noSeal:r}}function kn(){return function(e,t){const r=Symbol(t),i=Symbol(t);return{set:function(o){this[i]=new hl(this),this[r]=o},get:function(){return kt=this[i],this[r]}}}}const cl=new WeakMap;function dl(e,t,r={},i={}){let o=wo.get(e);o||(o=new Map,wo.set(e,o));const n=Object.assign(Object.assign(Object.assign({},r),o.get(t)||{}),i);return o.set(t,n),n}class hl{constructor(t){this.host=t,t.addController(this)}update(){const t=kt;kt=this,this.host.requestUpdate(),this.host.updateComplete.then(()=>{kt=t})}hostConnected(){this.host.updateComplete.then(()=>{kt=void 0})}}class ul extends Error{constructor(t){super(`Access to '${t}' is locked. Needs unlocked context for access!`)}}const wo=new WeakMap,at=new WeakMap;let kt,pl=null;const fl="0.0.23",Pn=()=>new Date(Date.now()).toLocaleDateString("en-US",{weekday:"long"}).toLowerCase(),ml=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"],gl=e=>ml.includes(e),vl=e=>{const t=window.location.search;return new URLSearchParams(t).get(e)};var bl=Object.defineProperty,yl=Object.getOwnPropertyDescriptor,_l=(e,t,r,i)=>{for(var o=i>1?void 0:i?yl(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=(i?s(t,r,o):s(o))||o);return i&&o&&bl(t,r,o),o};let Gr=class{constructor(){this.urlDayParam=vl("day"),this.weekDay=this.urlDayParam&&gl(this.urlDayParam)?this.urlDayParam:Pn()}};Gr=_l([sl()],Gr);const Tn=new Gr,wl=async e=>new Promise(t=>{setTimeout(()=>t(),e)}),$l=async(e,t=!0)=>(t&&await wl(500),await(await fetch(e)).json());var xl=Object.defineProperty,Al=Object.getOwnPropertyDescriptor,On=(e,t,r,i)=>{for(var o=i>1?void 0:i?Al(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=(i?s(t,r,o):s(o))||o);return i&&o&&xl(t,r,o),o};let Je=class extends et{constructor(){super();this._apiTask=new nl(this,()=>$l(`http://localhost:3000/day/${this.state.weekDay}`),()=>[this.state.weekDay]),this.state=Tn;const e={}.VITE_SCRR;console.log({endPoint:e})}static get styles(){return[Sn,Lt`
    ...
    `}};On([kn()],Je.prototype,"state",2);Je=On([Xt("app-discount")],Je);var El=Object.freeze(Object.defineProperty({__proto__:null,get AppDiscount(){return Je}},Symbol.toStringTag,{value:"Module"})),Sl=Object.defineProperty,Cl=Object.getOwnPropertyDescriptor,ci=(e,t,r,i)=>{for(var o=i>1?void 0:i?Cl(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=(i?s(t,r,o):s(o))||o);return i&&o&&Sl(t,r,o),o};let Ge=class extends et{constructor(){super();this.title="Discount Day",this.enableBack=!1}static get styles(){return Lt`
      header {
        display: flex;
        justify-content: space-between;
        align-items: center;
    ...
    `}};ci([wt({type:String})],Ge.prototype,"title",2);ci([wt({type:Boolean})],Ge.prototype,"enableBack",2);Ge=ci([Xt("app-header")],Ge);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function dc(e,t,r){return e?t():r==null?void 0:r()}var hc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,Se=(e,t,r,i)=>{for(var o=i>1?void 0:i?uc(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=(i?s(t,r,o):s(o))||o);return i&&o&&hc(t,r,o),o};let Gt=class extends et{constructor(){super(...arguments);this.business="",this.category="",this.discountName="",this.price=4.9,this.formatPrice=e=>new Intl.NumberFormat("de-DE",{style:"currency",currency:"EUR"}).format(e)}static get styles(){return[Lt`
    ...
    `}constructor(){super()}firstUpdated(){var t;new gt((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/discount-day/",animate:!0,children:[{path:"",component:"app-discount"},{path:"discount",component:"app-discount",action:async()=>{await yi(()=>Promise.resolve().then(function(){return El}),void 0)}},{path:"about",component:"app-about",action:async()=>{await yi(()=>import("./app-about.6db67e90.js"),[])}}]}])}render(){return N`
      <div>
        <main>
          <div id="routerOutlet"></div>
        </main>
      </div>
    `}};Lo=mc([Xt("app-index")],Lo);export{Sn as a,Xt as e,Lt as i,et as s,N as y};
//# sourceMappingURL=index.2a088a1a.js.map
